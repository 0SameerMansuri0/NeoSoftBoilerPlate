...
namespace MovieRentalApp.Migrations
{
    ...
    [Migration("20230609090244_sadsadsa")]
    partial class sadsadsa
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "9e583acf-d6aa-4f15-9c56-977fde40d11a",
                            Name = "Administrator",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "08f0e6e1-2b5d-4370-b8eb-e8a134435701",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("MovieRentalApp.Context.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d8ec6aa4-7e89-4023-a7df-21289e832959",
                            Email = "admin@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedUserName = "ADMIN@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEP7C+lnW5mOlFaZsPbnbvumwZDDdDYhcTBVNYPzbqOXKJXxjhSKTBskkSJGfG9Qv/A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "714d8b7c-d5f9-4087-b1a4-498d8207ac3f",
            ...
            modelBuilder.Entity("MovieRentalApp.Models.RegisterModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MovieRentalApp.Context.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MovieRentalApp.Models.Bookiing", b =>
                {
                    ...
                    b.HasOne("MovieRentalApp.Context.User", "user")
                        .WithMany("bookiings")
                        .HasForeignKey("userId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
